...
if __name__ == "__main__":
    ...
    convert(SRC/"privacy-policy.md",       "Privacy Policy — Streakline",       "privacy.html", foot)
    convert(SRC/"terms-and-conditions.md", "Terms and Conditions — Streakline", "terms.html",   foot)
